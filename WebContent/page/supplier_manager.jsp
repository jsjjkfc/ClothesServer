				...
				<ul class="nav nav-list">
					<li class="active open"><a href="#" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li><a href="/ClothesServer/type/page"> <i
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">供应商管理</h3>
									<div class="table-header">供应商详情列表</div>
										...
										<table id="sample-table-2"
											...
											<h4 class="pink" style="float: right; margin-right: 10px">
												<i class="icon-plus blue"></i> <a href="#modal-table"
													role="button" class="green" data-toggle="modal"> 添加供应商
												</a>
											</h4>
											<thead>
												<tr>
											...
											<form class="form-horizontal" id="prductForm"
												...
												<div class="form-group">
													<label for="supplierDesc"
														...
														供应商描述 </label>
													<div class="col-sm-9">
														<input type="text" name="desc" id="supplierDesc"
							...
							$("#modal-table")
									...
									.html(
											"<button type='button' class='close' data-dismiss='modal' aria-hidden='true'><span class='white'>&times;</span></button>"
													+ "添加供应商");
							initform("/ClothesServer/supplier/addSupplier");
						});
		function edit(row) {
			var rowData = supplierDatas.aaData[row];
			$('#form-submit').html('<i class="icon-pencil white"></i>更新');
			$("#supplierDesc").val(rowData.desc);
			$("#supplierDesc").attr("value", rowData.desc);
			$("#supplierid").attr("value", rowData.supplierId);
			$("#modal-table")
					.find(".table-header")
					.html(
							"<button type='button' class='close' data-dismiss='modal' aria-hidden='true'><span class='white'>&times;</span></button>"
									+ "修改供应商信息");
			initform("/ClothesServer/supplier/upSupplier");
		}
		...
		function del(id) {
			bootbox.confirm({
				...
				callback : function(result) {
					if (result) {
						$.ajax({
							url : "/supplier/deleteSupplier",//这个就是请求地址对应sAjaxSource
							data : {
				...
				.dataTable(
						{
							...
							"sAjaxSource" : "/ClothesServer/supplier/queryPaged",//这个是请求的地址
